      ...
      <div className="page">
         <header className="hero">
            <div className="hero__content">
               ...
               <h1>
                  Compress images in seconds - no installs, no uploads to
                  servers.
               </h1>
               <p className="lede">
                  Drop your photos, tune the quality, and download lighter files
                  while keeping clarity. Everything runs in your browser for
                  privacy.
               </p>
               <div className="hero__actions">
                  <a className="button primary" href="#compressor">
                     Start compressing
                  </a>
                  <a
                     className="button ghost"
                     href="https://github.com/SafwanIrfan/Image-Compressor"
                     target="_blank"
                     rel="noreferrer"
                  >
                     View on GitHub
            ...
            <div className="hero__card">
               ...
               <p className="small">
                  Pick a file and see the compressed result instantly.
               </p>
               ...
               <a className="button primary block" href="#compressor">
                  Try it now
               </a>
            </div>
         </header>
         ...
         <main>
            <section id="compressor" className="section">
               <div className="section__header">
                  ...
                  <p className="lede">
                     Adjust quality and dimensions, preview instantly, and
                     download a lighter copy.
                  </p>
               </div>
               <CompressorSection />
            </section>
            ...
            <section className="section alt">
               <div className="section__header">
                  ...
                  <p className="lede">
                     No account, no uploads—just quick compression in your
                     browser.
                  </p>
               </div>
               <div className="grid features">
                  <div className="card">
                     <h3>Privacy-first</h3>
                     <p>
                        Everything stays on your device. The tool never sends
                        your images to a server.
                     </p>
                  </div>
                  <div className="card">
                     <h3>Lightweight</h3>
                     <p>
                        Built with React and Vite for fast loads and snappy
                        interactions.
                     </p>
                  </div>
                  <div className="card">
                     ...
                     <p>
                        Quality slider, dimension limits, and instant
